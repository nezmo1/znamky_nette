<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/config/config.neon 
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\app',
			'wwwDir' => 'E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('E:\\xampp2\\htdocs\\znamky_nette\\sandbox\\app/../temp/cache', $this->getService('nette.cacheJournal'));
