...
list($_b, $_g, $_l) = $template->initialize('1641653341', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb42f02b25ee_content')) { function _lb42f02b25ee_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
