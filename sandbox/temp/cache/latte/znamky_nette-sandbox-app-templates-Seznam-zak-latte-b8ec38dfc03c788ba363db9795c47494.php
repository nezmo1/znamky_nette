...
list($_b, $_g, $_l) = $template->initialize('9118710916', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbd130f7c594_content')) { function _lbd130f7c594_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
