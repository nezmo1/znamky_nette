<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/Nastaveni/globalninastaveni.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6299150036', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbfd8e054839_content')) { function _lbfd8e054839_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
