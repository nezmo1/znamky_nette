<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/Edit/trida.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0517217582', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbf6f70a66ba_content')) { function _lbf6f70a66ba_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["editTrida"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
