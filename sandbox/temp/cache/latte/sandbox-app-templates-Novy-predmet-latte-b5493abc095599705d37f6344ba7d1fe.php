...
list($_b, $_g, $_l) = $template->initialize('8994858882', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb14ffeda97c_content')) { function _lb14ffeda97c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
