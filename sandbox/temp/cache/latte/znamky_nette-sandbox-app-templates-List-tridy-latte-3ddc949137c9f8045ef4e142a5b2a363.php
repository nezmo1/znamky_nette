...
list($_b, $_g, $_l) = $template->initialize('2067245212', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb21220fdfaf_content')) { function _lb21220fdfaf_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
