<?php
// source: D:\xampp\htdocs\znamky_nette\znamky_nette\sandbox\app/templates/Edit/cvZnamka.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5123221902', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbc859fdd6bb_content')) { function _lbc859fdd6bb_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
  $(function() {
...
<div style="float:left"><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Seznam:cvUcitel"), ENT_COMPAT) ?>
...
<table>
    <thead><tr ><th colspan='2' style='font-size:18px; text-align: center; '>Editace čtvrtletní klasifikace</th></tr></thead>
<?php $_l->tmp = $_control->getComponent("editCvZnamka"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
