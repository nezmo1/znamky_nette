<?php
// source: D:\xampp\htdocs\znamky_nette\znamky_nette\sandbox\app/templates/Edit/zak.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2041072919', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb5e3474956a_content')) { function _lb5e3474956a_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div style="float:left"><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("List:zaci"), ENT_COMPAT) ?>
...
<table>
    <thead><tr ><th colspan='2' style='font-size:18px; text-align: center; '>Editace žáka</th></tr></thead>
