<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/Edit/heslo.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4596766707', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb13ac30a4e9_content')) { function _lb13ac30a4e9_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="right_col" role="main">
         
            <div class="page-title">
              <div class="title_left">
                  <h3>Změna hesla <small><?php echo Latte\Runtime\Filters::escapeHtml($uzivatel['prijmeni'], ENT_NOQUOTES) ?>
 <?php echo Latte\Runtime\Filters::escapeHtml($uzivatel['jmeno'], ENT_NOQUOTES) ?></small></h3>
              </div>
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["zmenaHeslaA"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
...
<script>
        function zpetNaSeznam(){
            window.location = <?php echo Latte\Runtime\Filters::escapeJs($basePath) ?>
 + <?php echo Latte\Runtime\Filters::escapeJs($zpet) ?>;
        }
