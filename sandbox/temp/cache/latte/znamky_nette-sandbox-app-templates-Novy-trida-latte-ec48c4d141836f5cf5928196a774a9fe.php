<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/Novy/trida.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2773148572', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbb046c3869f_content')) { function _lbb046c3869f_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["novyTrida"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
