<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/Edit/skupina.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6381161046', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbb9969b67d5_content')) { function _lbb9969b67d5_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="right_col" role="main">
         
            <div class="page-title">
              <div class="title_left">
                <h3>Editace skupiny</h3>
              </div>
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["editSkupina"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
