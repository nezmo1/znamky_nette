<?php
// source: D:\xampp\htdocs\znamky_nette\sandbox\app/templates/Znamka/vygenFormNovaZnamka.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3474647106', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb655c0cf232_content')) { function _lb655c0cf232_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
