<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/Nastaveni/personalninastaveni.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4299962912', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb7ecd0a5e45_content')) { function _lb7ecd0a5e45_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="right_col" role="main">
         
            <div class="page-title">
              <div class="title_left">
                  <h3>Personální nastavení <small></small></h3>
              </div>
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["perZmenaHesla"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
...
" style='<?php if ($flash->message=='Heslo úspěšně změněno') { ?> color:green <?php } ?>
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["perEmail"], array($form)) ?>
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["perSirkaZnamky"], array($form)) ?>
