<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/Edit/zak.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5319909654', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb0f5ba595a4_content')) { function _lb0f5ba595a4_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["novyZak"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
...
<script>
        function zpetNaSeznam(){
            window.location = <?php echo Latte\Runtime\Filters::escapeJs($basePath) ?> + "/list/zaci";
        }
