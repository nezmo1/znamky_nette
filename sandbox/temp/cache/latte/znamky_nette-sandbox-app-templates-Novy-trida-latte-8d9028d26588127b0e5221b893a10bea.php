<?php
// source: D:\xampp\htdocs\znamky_nette\sandbox\app/templates/Novy/trida.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2100896291', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1d7cf02125_content')) { function _lb1d7cf02125_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
