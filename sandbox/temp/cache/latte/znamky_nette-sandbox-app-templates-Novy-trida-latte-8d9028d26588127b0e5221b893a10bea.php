...
list($_b, $_g, $_l) = $template->initialize('5236360689', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba94c11633d_content')) { function _lba94c11633d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
