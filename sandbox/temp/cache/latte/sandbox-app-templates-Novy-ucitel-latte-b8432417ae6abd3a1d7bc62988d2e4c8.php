...
list($_b, $_g, $_l) = $template->initialize('6481064092', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb43a160e087_content')) { function _lb43a160e087_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
