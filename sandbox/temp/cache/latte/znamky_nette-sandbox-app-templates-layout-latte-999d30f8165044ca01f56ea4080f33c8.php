...
list($_b, $_g, $_l) = $template->initialize('4559645190', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb80e56659a0_scripts')) { function _lb80e56659a0_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
