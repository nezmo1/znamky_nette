...
list($_b, $_g, $_l) = $template->initialize('7209402887', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbee237c3648_scripts')) { function _lbee237c3648_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
