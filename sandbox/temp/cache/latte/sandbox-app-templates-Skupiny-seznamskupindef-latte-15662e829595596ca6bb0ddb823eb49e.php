...
list($_b, $_g, $_l) = $template->initialize('0247247123', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb3c98f2d5e9_content')) { function _lb3c98f2d5e9_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
