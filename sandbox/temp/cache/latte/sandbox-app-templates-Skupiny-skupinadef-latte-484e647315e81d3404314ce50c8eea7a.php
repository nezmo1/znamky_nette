...
list($_b, $_g, $_l) = $template->initialize('6509445417', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbb8e0eb87b4_content')) { function _lbb8e0eb87b4_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
