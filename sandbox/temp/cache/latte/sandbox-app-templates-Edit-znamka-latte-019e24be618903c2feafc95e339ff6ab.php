<?php
// source: D:\xampp\htdocs\znamky_nette\sandbox\app/templates/Edit/znamka.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6642986847', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbfb81e842fd_content')) { function _lbfb81e842fd_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
  $(function() {
