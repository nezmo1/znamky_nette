...
list($_b, $_g, $_l) = $template->initialize('1469892028', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2f2830bb8b_content')) { function _lb2f2830bb8b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
