<?php
// source: D:\xampp\htdocs\znamky_nette\sandbox\app/templates/Novy/zak.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9943605848', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba8a4be139e_content')) { function _lba8a4be139e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
