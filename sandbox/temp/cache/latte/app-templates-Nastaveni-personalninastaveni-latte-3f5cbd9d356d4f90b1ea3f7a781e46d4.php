<?php
// source: D:\xampp\htdocs\znamky_nette\sandbox\app/templates/Nastaveni/personalninastaveni.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5002576896', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1b9e306873_content')) { function _lb1b9e306873_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;if (!$user->isInRole('1')) { ?>
