...
list($_b, $_g, $_l) = $template->initialize('0656752585', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba934388c4a_content')) { function _lba934388c4a_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;if (!$user->isInRole('1')) { ?>
