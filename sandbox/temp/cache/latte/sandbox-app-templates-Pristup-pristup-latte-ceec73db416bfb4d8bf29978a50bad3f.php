...
list($_b, $_g, $_l) = $template->initialize('8274787899', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1fa42b0769_content')) { function _lb1fa42b0769_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
