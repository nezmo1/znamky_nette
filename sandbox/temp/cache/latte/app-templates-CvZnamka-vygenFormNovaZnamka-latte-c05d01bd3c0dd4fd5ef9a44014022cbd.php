<?php
// source: E:\xampp2\htdocs\znamky_nette\sandbox\app/templates/CvZnamka/vygenFormNovaZnamka.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2987029452', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb0b42abfd1d_content')) { function _lb0b42abfd1d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
...
. třída - <?php echo Latte\Runtime\Filters::escapeHtml($predmet['nazev'], ENT_NOQUOTES) ?> </h2>
