...
list($_b, $_g, $_l) = $template->initialize('9818983471', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _grid
//
if (!function_exists($_b->blocks['_grid'][] = '_lb4524cf6ac0__grid')) { function _lb4524cf6ac0__grid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('grid', FALSE)
...
// block outerFilter
//
if (!function_exists($_b->blocks['outerFilter'][] = '_lb82e9581ab5_outerFilter')) { function _lb82e9581ab5_outerFilter($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block table
//
if (!function_exists($_b->blocks['table'][] = '_lbf638598482_table')) { function _lbf638598482_table($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php if (is_string($column->getCustomRender()) && $column->getCustomRenderVariables()) { $_b->templates['9818983471']->renderChildTemplate($column->getCustomRender(), array_merge(array('control' => $control, 'presenter' => $control->getPresenter(), 'item' => $row, 'column' => $column, ), $column->getCustomRenderVariables(), array()) + $template->getParameters()) ;} elseif (is_string($column->getCustomRender())) { $_b->templates['9818983471']->renderChildTemplate($column->getCustomRender(), array('control' => $control, 'presenter' => $control->getPresenter(), 'item' => $row, 'column' => $column) + $template->getParameters()) ;} else { ?>
...
// block action
//
if (!function_exists($_b->blocks['action'][] = '_lb39275c9c6f_action')) { function _lb39275c9c6f_action($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block operations
//
if (!function_exists($_b->blocks['operations'][] = '_lb5e27e82e6b_operations')) { function _lb5e27e82e6b_operations($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block paginator
//
if (!function_exists($_b->blocks['paginator'][] = '_lb8ca32b342c_paginator')) { function _lb8ca32b342c_paginator($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block count
//
if (!function_exists($_b->blocks['count'][] = '_lb1c253944e3_count')) { function _lb1c253944e3_count($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>                <span class="count">
